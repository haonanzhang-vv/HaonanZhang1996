...
The initial appearance of this equation might not be very intuitive, but it essentially aligns with the definition of the ROC curve. If we let $$ c = S_0^{-1}(t) $$, noting that c is the threshold corresponding to FPF t, then 
